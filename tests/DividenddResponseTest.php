...
class DividenddResponseTe extends TestCase
{
    /**
     * Set up test.
     *
    ...
    public function setUp()
    {
        ...
        $this->response = Dividend\DividenddResponse::createFrom($this->guzzleResponse);
    ...
    {
        $response = Dividend\DividenddResponse::createFrom(
    ...
    public function testCreateFrom()
    {
        ...
        $response = Dividend\DividenddResponse::createFrom($guzzleResponse);

        $this->assertInstanceOf(Dividend\DividenddResponse::class, $response);
    ...
    public function testSerialize()
    {
        ...
        $class = Dividend\DividenddResponse::class;
